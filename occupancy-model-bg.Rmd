...
```{r}
write.table(x=out3.sum,file="results/fxnlgrpbg-032320.csv",sep=",") # save output
...
write.table(x = psimeans, file = "results/fxnlgrpbg-032320_alphaspsi()p().csv", sep = ",")

pmeans <- colMeans(logit.p)
names(pmeans) <- sppnames2
write.table(x = pmeans, file = "results/fxnlgrpbg-032320_detection.csv", sep=",")
...
write.table(x=psiCI, file="results/fxnlgrpbg-032320_alphaCI.psi()p().csv",sep=",")
...
write.table(x = pCI, file="results/fxnlgrpbg-032320_pCI.psi()p().csv", sep = ",")
```
...
write.table(x = group, file = "results/fxnlgrpbg-032320_group.csv", sep = ",", row.names=F)
...
write.csv(group_param_long, "results/fxnlgrpbg-032320_groupcovposteriors.csv", row.names = F)
...
# export the table
write.table(x=species,file="results/fxnlgrpbg-032320_species.csv",sep=",", row.names=F) 
...
write.table(x=z.all,file="results/fxnlgrpbg-032320_rawrichnessdistribution.csv",sep=",", row.names=F)
...
write.table(x=z.all,file="results/fxnlgrpbg-032320_spprich.csv",sep=",", row.names=F)
...
write.table(x=z.group,file="results/fxnlgrpbg-032320_grouprich.csv",sep=",", row.names=F)
```
